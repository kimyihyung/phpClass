<?php
    ...
    $blogSql = "SELECT * FROM classBlog WHERE blogID = {$myBlogID}";
    $blogResult = $connect -> query($blogSql);
    $blogInfo = $blogResult -> fetch_array(MYSQLI_ASSOC); //데이터 가져오기

    $commentSql = "SELECT * FROM classComment WHERE blogID = '$myBlogID' ORDER BY commentID DESC";
            ...
            <div class='blog__inner'>
                <div class="blog__contents">
                    ...
                    <div class="blog__contents__cont">
                        <img src="../assets/blog/<?=$blogInfo['blogImgSrc']?>" alt="">
                        ...
                        <div class="comment" id="comment<?=$comment['commentID']?>">
                            <div class="comment__view">
                                <div class="comment__view__img">
                                    ...
                                    <div class='comment_profile' style='background-image:url(../assets/blog/<?=$blogInfo['blogImgSrc']?>)'></div>
                                </div>
