...
<?php
    ...
    // echo $boardID;
    // 보드뷰 + 1(UPDATE)
    $sql = "UPDATE classBoard SET boardView = boardView + 1 WHERE boardID = {$boardID}";
    $connect -> query($sql);
    $sql = "SELECT b.boardTitle, m.youName, b.regTime, b.boardView, b.boardContents FROM classBoard b JOIN classMember m ON(m.memberID = b.memberID) WHERE b.boardID = {$boardID}";
